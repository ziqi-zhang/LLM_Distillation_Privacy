...
# Teacher
# BATCH_SIZE=4
TEACHER_CKPT_NAME="opt-${MODEL_SIZE}"
KD_SAVE_PATH="${ROOT_SAVE_DIR}/sft"
TEACHER_CKPT_PATH="${KD_SAVE_PATH}/final"
...
MEM_SAVE_PATH="${KD_SAVE_PATH}/memorization_w_teacher"
...
#     bash ${SCRIPT_DIR}/memorize_w_teacher.sh $GPUS $BATCH_SIZE $MEM_SAVE_PATH $CKPT_NAME $CKPT_PATH $TEACHER_CKPT_NAME $TEACHER_CKPT_PATH
# fi
bash ${SCRIPT_DIR}/memorize_w_teacher.sh $GPUS $BATCH_SIZE $MEM_SAVE_PATH $CKPT_NAME $CKPT_PATH $TEACHER_CKPT_NAME $TEACHER_CKPT_PATH
