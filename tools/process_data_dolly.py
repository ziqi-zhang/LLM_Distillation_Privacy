...
def main():
    ...
    for split in all_data:
        ...
        split_data_size = {}
        for split in all_data:
            with open(os.path.join(args.processed_data_dir, f"{split}.jsonl")) as json_file:
                lines = json_file.readlines()
                split_data_size[split] = len(lines)
        with open(os.path.join(args.processed_data_dir, "data_size.json"), "w") as f:
            json.dump(split_data_size, f)
